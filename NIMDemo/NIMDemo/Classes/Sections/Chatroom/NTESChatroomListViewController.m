...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NIMChatroomEnterRequest *request = [self requestWithChatroom:chatroom];
    [SVProgressHUD show];
...
- (NIMChatroomEnterRequest *)requestWithChatroom:(NIMChatroom *)chatroom
{
