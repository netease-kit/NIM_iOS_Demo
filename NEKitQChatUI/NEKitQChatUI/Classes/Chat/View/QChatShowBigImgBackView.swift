...
public class QChatShowBigImgBackView: UIView {
    ...
    lazy var collectionView : UICollectionView = {
        let layout = QChatPageFlowLayout.init() // 给分页添加间距
        ...
        collectionView.register(QChatImgCollectionViewCell.self, forCellWithReuseIdentifier: "CollectionViewCell")
...
extension QChatShowBigImgBackView: UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CollectionViewCell", for: indexPath) as! QChatImgCollectionViewCell
        if self.urlArr.count  != 0 {
...
// MARK: 点击的方法
extension QChatShowBigImgBackView {
...
extension QChatShowBigImgBackView {
    ...
    public func transformAnimation() {
        ...
        guard let cell = collectionView.cellForItem(at: indexPath) as? QChatImgCollectionViewCell else {
            return
        }
        self.showAnimation()
...
// MARK: 动画代理
extension QChatShowBigImgBackView: CAAnimationDelegate {
