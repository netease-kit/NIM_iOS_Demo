//
//  QChatServerSettingViewController.swift
//  NEKitQChatUI
//
...
//    var completion: SaveSuccessBlock?
    
    var headerImageUrl: String?
    
    var headerImage: QChatUserHeaderView?
    
    //var serverInput: UITextField?
...
//        print("server owner : ", server?.owner as Any)
    ...
    func headerView() -> UIView {
        ...
        if let icon = server?.icon {
            //header.kf.setImage(with: URL(string: icon), placeholder: nil, options: nil, progressBlock: nil, completionHandler: nil)
