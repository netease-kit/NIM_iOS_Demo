...
public class QChatPageFlowLayout: UICollectionViewFlowLayout {
...
extension QChatPageFlowLayout {
    ...
    public override func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        let offsetMax: CGFloat = self.collectionView?.contentSize.width ?? kScreenWidth - (pageSpace + self.sectionInset.right + self.minimumLineSpacing)
