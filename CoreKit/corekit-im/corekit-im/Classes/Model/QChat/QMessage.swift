...
//  CoreKit-IM
//
//  Created by yuanyuan on 2022/2/28.
//

import Foundation
import NIMSDK
enum MessageType: Int {
    case Text = 0, Image, Audio, Video, Location, Notification, File, Tip, Robot, RtcCallRecord, Custom
}
