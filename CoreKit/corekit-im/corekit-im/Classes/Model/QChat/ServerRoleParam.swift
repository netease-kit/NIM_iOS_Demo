...
public enum ChatPermissionType: String {
    ...
    case modifySelfInfo = "modifySelfInfo"
    // 邀请他人进入server的，仅server有
    case inviteToServer = "inviteToServer"
    // 踢除他人的权限，仅server有
    case kickOthersInServer = "kickOthersInServer"
    // 修改他人在该server的服务器成员信息，仅server有
    case modifyOthersInfoInServer = "modifyOthersInfoInServer"
    // 撤回他人消息的权限，server和channel都有
    case revokeMsg = "revokeMsg"
    // 删除他人消息的权限，server和channel都有
    case deleteOtherMsg = "deleteOtherMsg"
    //  @ 他人的权限，server和channel都有
    case remindOther = "remindOther"
    // @ everyone的权限，server和channel都有
    case remindAll = "remindAll"
    // 管理黑白名单的权限，server和channel都有
    case manageBlackWhiteList = "manageBlackWhiteList"
    // default
    case none = "none"
