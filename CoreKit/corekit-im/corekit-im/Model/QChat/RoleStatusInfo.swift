...
public enum type:Int {
    case ManageServer  = 1, ManageChannel,ManageRole,SendMsg,ModifySelfInfo,InviteToServer,KickOthersInServer,ModifyOthersInfoInServer,RevokeMsg,DeleteOtherMsg,RemindOther,RemindAll,BlackWhiteList
}
